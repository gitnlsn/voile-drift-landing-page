...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "metadata.veraPrivacy" });
...
export default async function VeraPrivacyPage({ params }: Props) {
  const { locale } = await params;
  setRequestLocale(locale);
  const t = await getTranslations({ locale, namespace: "veraPrivacy" });
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">
                {t("sections.informationCollected.healthTitle")}
              </h3>
              <p className="text-muted-foreground mb-4">
                {t("sections.informationCollected.healthIntro")}
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                <li>
                  <strong>{t("sections.informationCollected.healthItems.menstrualCycle")}</strong>
                </li>
                <li>
                  <strong>{t("sections.informationCollected.healthItems.periodDates")}</strong>
                </li>
                <li>
                  <strong>{t("sections.informationCollected.healthItems.symptoms")}</strong>
                </li>
                <li>
                  <strong>{t("sections.informationCollected.healthItems.predictions")}</strong>
                </li>
              </ul>
              <p className="text-muted-foreground mb-4">
                {t("sections.informationCollected.healthPurpose")}
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                ...
                <li>{t("sections.howWeUse.items.predictions")}</li>
                <li>{t("sections.howWeUse.items.healthConnect")}</li>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">
                {t("sections.thirdParty.healthConnectTitle")}
              </h3>
              <p className="text-muted-foreground mb-4">
                {t("sections.thirdParty.healthConnectContent")}
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
                ...
                <li>{t("sections.dataSecurity.items.localStorage")}</li>
